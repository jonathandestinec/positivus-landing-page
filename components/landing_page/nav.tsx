...
const MobileNav = () => {
    return (
        <nav className="md:hidden flex items-center justify-between mt-0 bg-white w-full px-6 py-6">
            <Image src="/assets/logoname.png" alt="Logo" width={219.54} height={50} className=' w-30'/>
            <Menu />
        </nav>
    )
}
...
const Nav = () => {
    return (
        <div className=''>
            <nav className="md:flex hidden px-25 items-center justify-between mt-15 bg-white w-full">
